...
const navItems = [
  ...
  { href: "/gym-owner/profile", label: "Gym Profile", icon: Building2 },
  { href: "/gym-owner/trainers", label: "Trainer Requests", icon: Users },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 min-w-0">
        <div className="lg:hidden sticky top-0 z-30 h-16 bg-white border-b border-gray-200 flex items-center px-4">
          ...
          <span className="ml-4 font-semibold text-black">Gym Owner</span>
        </div>
