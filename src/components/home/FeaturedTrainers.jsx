"use client";
  ...
  export default function FeaturedTrainers() {
    ...
    return (
      <section className="relative z-10 - overflow-hidden  bg-gray-50 px-6 pb-12 pt-16 md:px-0 md:pt-12 md:pb-12">
        {/* Ambient accent */}
    ...
    return (
      <>
        ...
        <div className=" flex justify-center">
          <Link
            href="/trainers"
            className="rounded-full bg-black px-6 py-3 mt-8 text-sm font-bold text-white transition-all hover:-translate-y-0.5 hover:shadow-lg"
          >
