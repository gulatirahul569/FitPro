    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <select
          ...
          className="w-full sm:w-auto px-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-black transition-all text-sm bg-white"
        >
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 md:contents">
                  <div className="md:col-span-3">
                    <p className="text-[11px] uppercase tracking-wide text-gray-400 md:hidden mb-1">
                      Joined
                    </p>
                ...
                {/* Role selector */}
                <div className="md:col-span-3 flex flex-col gap-1 md:items-end">
                  <label className="text-[11px] uppercase tracking-wide text-gray-400 md:hidden">
                    Change Role
                  </label>
                  ...
                  <select
                    ...
                    className="w-full md:w-auto px-3 py-2 md:py-1.5 rounded-lg border border-gray-200 text-sm md:text-xs font-medium focus:outline-none focus:border-black transition-all bg-white disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  {loadingId === user._id && (
                    <p className="text-[11px] text-blue-600 md:hidden">
                      Updating role…
                    </p>
                  )}
                </div>
